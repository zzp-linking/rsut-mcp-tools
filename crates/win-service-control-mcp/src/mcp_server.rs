...
pub fn run_loop(manager: ServiceManager, proc_manager: ProcessManager) {
    let stdin = io::stdin();
    ...
    for line in stdin.lock().lines() {
        ...
        let response = handle(method, params, id, &manager, &proc_manager);
...
fn handle(
    ...
    match method {
        ...
        "tools/call" => {
            ...
            let result = tools::call_tool(tool_name, args, manager, proc_manager);
